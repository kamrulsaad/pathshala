            ...
            <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
                    <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
                        ...
                        <div>
                            <p className="font-medium tracking-wide text-gray-300">Connections</p>
                            <ul className="mt-2 space-y-2">
                                <li>
                                    <a
                                        href="/"
                        ...
                        <div>
                            <p className="font-medium tracking-wide text-gray-300">Communications</p>
                            <ul className="mt-2 space-y-2">
                                <li>
                                    <a
                                        href="/"
                    ...
                    <div className="md:max-w-md lg:col-span-2">
                        ...
                        <p className="mt-4 text-sm text-gray-500">
                            Your all time favourite creative learnig platform
                        </p>
                    </div>
                </div>
                <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
                    <p className="text-sm text-gray-500">
                        © Copyright {year} Pathshala inc. All rights reserved.
                    </p>
